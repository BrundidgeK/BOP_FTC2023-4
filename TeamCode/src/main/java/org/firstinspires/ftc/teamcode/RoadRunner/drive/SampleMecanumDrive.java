...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        rightRear = hardwareMap.get(DcMotorEx.class, "Front Left"); //
        rightFront = hardwareMap.get(DcMotorEx.class, "Front Right");
        leftFront = hardwareMap.get(DcMotorEx.class, "Back Right"); //
    ...
    public List<Double> getWheelPositions() {
        ...
        int index = 0;
        for (DcMotorEx motor : motors) {
            int position = index == 0 || index == 2 ? -motor.getCurrentPosition() : motor.getCurrentPosition();
    ...
    public List<Double> getWheelVelocities() {
        ...
        int index = 0;
        for (DcMotorEx motor : motors) {
            int vel = (int) (index == 0 || index == 2 ? -motor.getVelocity() : motor.getVelocity());
            lastEncVels.add(vel);
